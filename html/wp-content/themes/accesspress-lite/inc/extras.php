...
function accesspresslite_bxslidercb(){
    ...
    <?php 
        	...
        	if(!empty($accesspresslite_settings['slider1']) || !empty($accesspresslite_settings['slider2']) || !empty($accesspresslite_settings['slider3']) || !empty($accesspresslite_settings['slider4'])){
				...
				'p' => $slider
					...
					<div class="slides">
							...
							<img alt="<?php echo get_the_title(); ?>" src="<?php echo esc_url($image[0]); ?>" style="width:100%;">
        ...
        <!-- MOD: This part is for adding the slides -->
        <div class="bx-slider">
			<div class="slides">
				<img src="<?php echo get_template_directory_uri(); ?>/images/demo/slide1.jpg" alt="slider1" style="width:100%;">
			...
			<div class="slides">
				<img src="<?php echo get_template_directory_uri(); ?>/images/demo/slide2.jpg" alt="slider2" style="width:100%;">
                <?php if($accesspresslite_settings['slider_caption']=='yes4' || empty($accesspresslite_settings['slider_caption'])):?>
				<div class="slider-caption">
					<div class="ak-container">
